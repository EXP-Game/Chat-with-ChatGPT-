# Chat-with-ChatGPT-
You want to sext with ChatGPT? Fine, now you can. ;)

Super easy:
- Make new project, set for project-only memory
- Copy/paste the custom instructions (right here in the repository!) into project instructions
- Change age if you wish - doesn't matter. It's set as a default 26 y/o right now.
